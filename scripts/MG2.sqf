//nul=[0,0,1,0,0,0,0,0] execVM "scripts\MGrange.sqf" 
_score = 0;
_ARscore = "";
...
{_x animate["terc",0]} forEach _target300m; //resets the target

_ARscore = format ["Autorifleman Group Two: %1 of 1",_score];
