...
_loop = 1;
_loop2 = 1;
_shooter = nearestObject [range1, "player"];

{_x  animate["terc",1]} forEach _targets; //puts the targets down before the start

nopop=true;

"Setting up Range 1" remoteExec ["hint", _shooter]; // Range setup hints to player who called the action.
sleep 2;
"Get Ready Range 1..." remoteExec ["hint", _shooter];
sleep 2;
...
"Range 1 Complete" remoteExec ["hint", _shooter];
sleep 2;
