//nul=[0,1,0,0,0,0,0,0] execVM "scripts\MGrange.sqf" 
_score = 0;
_ARscore = "";
...
{_x animate["terc",0]} forEach _target200m; //resets the target

_ARscore = format ["Autorifleman Group One: %1 of 1",_score];
